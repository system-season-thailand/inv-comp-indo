...
function processInvoiceData(data) {
    ...
    const extractData = (rawText) => {
        ...
        for (const line of lines) {
            ...
            // Handle hotel rows
                ...
                const accommodationOnlyHotels = ["AL JUMEIRAH", "ALJUMEIRAH", "MARSEILLIA", "AL ANDALUS", "ALANDALUS", "ANDALUS", "NEOM", "ALMARINA", "AL MARINA", "MARINA", "ALWAHA", "AL WAHA", "DIVAN", "AURA", "LONDON"];
    ...
    const createTotalPriceRow = (total, travelAgency, guestByRow) => {
        ...
        if (
            ...
            /\bRAYAN\b/.test(agencyUpper) ||
            /\bTURKI\b/.test(agencyUpper) ||
            /\bTURKEY\b/.test(agencyUpper) ||
            /\bTARIQ\b/.test(agencyUpper) ||
            /\bSECRET\b/.test(agencyUpper) ||
            /\bTRAVNUSA\b/.test(agencyUpper) ||
            /\bTURKY\b/.test(agencyUpper)
        ) {
            currency = "IDR";
        }


        /*  || agencyUpper.includes("LUXE CHECK") */
